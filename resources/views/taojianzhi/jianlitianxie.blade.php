...
<div class="rongqi" style="border:1px solid white;width:900px;top:20px;height:750px;position:relative;margin-left:-280px;cursor:default;">
    <div style="margin-left: 300px;margin-top: 0px;font-size: 20px;">你正在创建简历...</div>
    ...
    <div style="margin-left: 160px;border-top: 2px solid #eaeaea;width: 824;top:-10px;height:750px;position:relative;">
        <div class="jianli">
            <form method="post">
                &nbsp简&nbsp历&nbsp名：<input  type="text" name="J_name" style="width: 100px;height: 30px;"><br>
                &nbsp姓&nbsp&nbsp&nbsp&nbsp名：<input  type="text" name="name" style="width: 100px;height: 30px;">
                <input type="radio"name="sex" value="1" checked>男
                <input type="radio"name="sex" value="2">女
                <br>
                <div style="width:970px; margin:10px auto;">
                    出生日期：<input placeholder="请输入日期" name="date" class="laydate-icon" onclick="laydate()">
                </div>
                <br>
                &nbsp籍 &nbsp  &nbsp贯：
                ...
                <br>
                电子邮箱：<input type="text" name="mail" style="height: 30px;">
                <br>
                手机号码：<input type="text" name="number" style="height: 30px;">
                <br><br>
                空余时间：<br><br>
                ...
                <br>
                自我介绍：<br><br>
                <textarea cols=50 rows=5 name="intro" style="margin-left:0px;margin-top:-10px;sition: absolute" placeholder="说出你的亮点吧"></textarea>
    ...
    <div style="margin-left: 160px;border-top: 2px solid #eaeaea;width: 824;top:100px;height:350px;position:relative;margin-top: 5px;">
        <div class="jianli">
            ...
            简历标题：
            <input type="text" name="title" style="height: 30px;"placeholder="例：求职淘宝客服">
            <br>
            职位类别：
            <input type="text"name="type" style="height: 30px;"placeholder="请输入"><br>
            期望薪资：<input type="text" name="pay" style="height: 30px;width: 100px;">元/小时
            <br>
            求职地区：<input type="text" name="city" style="height: 30px;width: 100px;"placeholder="请输入城市">
            <input type="text" name="quyu" style="height: 30px;width: 100px;"placeholder="请输入区域">
            <input type="text" name="shangquan" style="height: 30px;width: 100px;"placeholder="请输入商圈">
            <br>
